...
if (isset($_POST['tombol'])) {
    if (!isset($_FILES['foto']['tmp_name'])) {
        ...
        if ($file_size < 2048000 and ($file_type == 'image/jpeg' or $file_type == 'image/png')) {
            ...
            mysqli_query($koneksi, "INSERT INTO fasilitas VALUES ('','$keterangan','$foto','$file_name','$file_type','$file_size')");
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $db = "SELECT * FROM fasilitas ORDER BY id_fasilitas ASC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img class="d-block" src="ambil_foto.php?id_fasilitas=<?php echo $data['id_fasilitas']; ?>" width="200">
                                                </td>
                                                <td> <a href="edit_fasilitas_hotel.php?id_fasilitas=<?php echo $data['id_fasilitas']; ?>" class="btn btn-primary">Edit</a>
                                                    <a href="hapus_fasilitas_hotel.php?id_fasilitas=<?php echo $data['id_fasilitas']; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini ...?') ">Hapus</a>
                                                </td>
                                            </tr>
                                    </tbody>
                                <?php $no++;
